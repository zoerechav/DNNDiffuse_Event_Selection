...
from modules.add_DNNDiffuse import DNNDiffuseFinalLevel_v1_0_0_nugen
...
tray.AddModule(map_snowstorm_parameters,"SnowstormParameterMapper",Streams=[icetray.I3Frame.Stream("M")])
...
tray.Add(add_cc_tag, "add_cc_tag")
#final level cuts
tray.Add(DNNDiffuseFinalLevel_v1_0_0_nugen,"DNNDiffuseFinalLevel_v1_0_0_nugen")
